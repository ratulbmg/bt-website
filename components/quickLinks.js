...
const QuickLinks = () => {
  ...
  return (
    <div className="bg-[#1b3058] text-white border-t-4 border-yellow-300 w-1/4 h-[510px]">
          ...
          <p className="text-lg p-1 border-b cursor-pointer border-white hover:text-yellow-300 duration-1000" onClick={()=>{router.push("/faculty")}}>Laboratory</p>
          ...
          <p className="text-lg p-1 border-b cursor-pointer border-white hover:text-yellow-300 duration-1000" onClick={()=>{router.push("/faculty")}}>Distuinguished Alumni</p>
          <p className="text-lg p-1 border-b cursor-pointer border-white hover:text-yellow-300 duration-1000" onClick={()=>{router.push("/faculty")}}>UG and PG Syllabus</p>
        </div>
  )
}
